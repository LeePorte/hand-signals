<template>
  <div @mouseenter.self="mouseIn" @mouseleave.self="mouseOut" @click="removeOrder(messageId)" class="nod-message">
    <div class="nod-emoji-wrapper">
      <img v-if="hover" :src="getCloseButton" alt="Remove icon" class="nod-emoji" />
      <img v-else :src="getOrder" alt="Raise a Point of Order" class="nod-emoji" />
    </div>
...
export default {
  ...
  methods: {
    ...
    removeOrder(key) {
      ...
      this.$store.dispatch("removeOrder", key);
